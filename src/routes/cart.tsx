      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-8">
          ...
          <aside className="glass rounded-2xl p-6 h-fit lg:sticky lg:top-24 space-y-4">
            <h3 className="font-display text-xl">{t("cart.summary")}</h3>
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-gold">{subtotal >= 200 ? t("common.free") : "20 AED"}</span>
            </div>
            ...
            >
              {t("cart.checkout")} <ArrowRight className="w-4 h-4 rtl-flip" />
            </Link>
            <p className="text-xs text-center text-muted-foreground inline-flex items-center justify-center gap-1.5 w-full">
              <Banknote className="w-3.5 h-3.5 text-gold" /> {t("common.codAvailable")}
            </p>
          </aside>
        </div>
      </div>
